...
from task_code import compare_paydollar_sf, month_2_to_6, one_time_conversion, onhold, reactivation, response_leads, task_iPay88_token_to_secondary_token, task_pledges_burnt, task_token, winback_nfp, winback_onhold
...
def browse_folder():
    ...
    if folder_path:
        ...
        if selected_processing_option == "TM One Time Conversion To Pledge":
            ...
            task_pledges_burnt.burnt_flow(folder_path)
